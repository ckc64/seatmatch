...
import 'event_detailswith_group_model.dart';
export 'event_detailswith_group_model.dart';

class EventDetailswithGroupWidget extends StatefulWidget {
  const EventDetailswithGroupWidget({
    super.key,
  ...
  @override
  _EventDetailswithGroupWidgetState createState() =>
      _EventDetailswithGroupWidgetState();
}

class _EventDetailswithGroupWidgetState
    extends State<EventDetailswithGroupWidget> {
  late EventDetailswithGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventDetailswithGroupModel());
