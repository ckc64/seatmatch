...
import 'linked_i_n_auth_model.dart';
export 'linked_i_n_auth_model.dart';

class LinkedINAuthWidget extends StatefulWidget {
  const LinkedINAuthWidget({super.key});

  @override
  _LinkedINAuthWidgetState createState() => _LinkedINAuthWidgetState();
}
